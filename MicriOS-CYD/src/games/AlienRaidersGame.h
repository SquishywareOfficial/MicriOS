...
class AlienRaidersGame : public App {
  ...
  private:
    ...
    void smartBomb();
    void loseHealth();
    void triggerStationImpact(uint8_t lane);
    void startStationDestruction();
    ...
    uint16_t stationImpactMs_ = 0;
    uint16_t destructionTimerMs_ = 0;
