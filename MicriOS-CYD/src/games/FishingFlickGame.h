...
class FishingFlickGame : public App {
  ...
  private:
    ...
    void moveFish();
    int8_t quadrantAt(TouchUi::Point point) const;
    ...
    bool quadrantTouchDown_ = false;
    bool quadrantTapPending_ = false;
    uint8_t fishQuadrant_ = 0;
    uint8_t touchedQuadrant_ = 0xFF;
    uint8_t tappedQuadrant_ = 0xFF;
